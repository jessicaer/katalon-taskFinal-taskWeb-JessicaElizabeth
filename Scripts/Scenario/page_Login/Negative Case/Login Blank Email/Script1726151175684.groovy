...
WebUI.setText(findTestObject('page_Login/input_email'), '')
...
WebUI.waitForElementVisible(findTestObject('page_Login/txterror_Email-Blank'), 0)

WebUI.verifyElementVisible(findTestObject('page_Login/txterror_Email-Blank'))
