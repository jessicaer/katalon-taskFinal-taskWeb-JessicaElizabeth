...
WebUI.waitForElementVisible(findTestObject('page_Login/txterror_Invalid-Email-Password'), 0)

WebUI.verifyElementVisible(findTestObject('page_Login/txterror_Invalid-Email-Password'))
