...
WebUI.setText(findTestObject('Object Repository/page_Registrasi/input_Email'), 'jessicaer@gmail.com')

WebUI.setEncryptedText(findTestObject('Object Repository/page_Registrasi/input_Password'), 'HKui9YD9oskaPgQVrCHfUw==')

WebUI.click(findTestObject('Object Repository/page_Registrasi/div_Repeat Password'))

WebUI.setEncryptedText(findTestObject('Object Repository/page_Registrasi/input_Repeat-Password'), 'HKui9YD9oskaPgQVrCHfUw==')

WebUI.click(findTestObject('Object Repository/page_Registrasi/list_Security-Question'))

WebUI.click(findTestObject('Object Repository/page_Registrasi/span_Security-Question'))
...
WebUI.waitForElementVisible(findTestObject('Object Repository/page_Registrasi/lbl_Registration-Success'), 0)

WebUI.verifyElementVisible(findTestObject('page_Registrasi/lbl_Registration-Success'))
